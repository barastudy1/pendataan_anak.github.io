...
<a href="<?php echo base_url('Cpdf')?>" type="button" class="btn btn-Success">Laporan Data Anak</button></a>
<a href="<?php echo base_url('Cpdf_bantuan')?>" type="button" class="btn btn-Success">Laporan Penerima Bantuan</button></a>
<a href="<?php echo base_url('CekLogin/Logout')?>" type="button" class="btn btn-Success">Logout</button></a>
<br><br>
 <h4>Grafik Data Anak Desa Wedomartani</h4>
